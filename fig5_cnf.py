...
parser.add_argument('--width', type=int, default=64) # M
parser.add_argument('--hidden_dim', type=int, default=32)
parser.add_argument('--train_dir', type=str, default=None)
parser.add_argument('--results_dir', type=str, default="./fig5")
parser.add_argument('--dataset', type=str, default='circles', choices=['circles', 'moons'])
